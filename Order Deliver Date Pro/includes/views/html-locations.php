...
?>
<div class="orddd_locations_heading"> <?php _e( 'Use the below table to add different pickup locations of your store.', 'order-delivery-date' ); ?></div>
<br>
<div class="wrap">
	<table class="orddd-locations-table wc_input_table widefat">
	    <thead>
	        <tr>
	            <th><?php _e( 'Address 1', 'order-delivery-date' ); ?></th>
	            <th><?php _e( 'Address 2', 'order-delivery-date' ); ?></th>
	            <th><?php _e( 'City', 'order-delivery-date' ); ?></th>
	            <th><?php _e( 'State', 'order-delivery-date' ); ?></th>
	            <th><?php _e( 'Postcode', 'order-delivery-date' ); ?></th>
	            <th><?php _e( 'Country', 'order-delivery-date' ); ?></th>
	        </tr>
	    </thead>
	    <tfoot>
	        <tr>
	            <th colspan="8"> 
	                <a class="button plus orddd_locations_insert"><?php _e( 'Insert row', 'order-delivery-date' ); ?></a>
	                <a class="button minue orddd_locations_remove"><?php _e( 'Remove selected row' , 'order-delivery-date' ); ?></a>
	            </th> 
	        </tr>
	    </tfoot>
