	...
	class Ordd_All_Component {
		...
		public function __construct() {
			...
			if ( true === $is_admin ) {
                ...
                $ordd_welcome_page_header_text = '';
                $user = wp_get_current_user();
                
                if ( in_array( 'administrator', (array) $user->roles ) ) {
                    new orddd_ts_welcome ( $ordd_plugin_name, $ordd_plugin_prefix, $ordd_locale, $ordd_plugin_folder_name, $ordd_plugin_dir_name, $ordd_get_previous_version, $ordd_welcome_page_header_text );
                }
