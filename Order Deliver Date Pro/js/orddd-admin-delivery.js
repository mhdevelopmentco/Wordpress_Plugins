					 ...
					 jQuery.post( jQuery( "#orddd_admin_url" ).val() + "admin-ajax.php", data, function( response ) {
						 if( response == "yes" ) {
							 if( jQuery( "#admin_delivery_fields tr" ).length == 0 ) {
		                         ...
		                         jQuery( "#admin_delivery_fields" ).prepend( "<tr id=\"admin_time_slot_field\"><td>" + jQuery( "#orddd_time_field_name_admin" ).val() + "</td><td><select name=\"time_slot\" id=\"time_slot\" class=\"\" disabled=\"disabled\" style=\"cursor:not-allowed !important;width:150px;\" placeholder=\"\"><option value=\"0\">Select</option></select></td></tr>");
